...
public class GeografijaDAO {
    ...
    private GeografijaDAO(){
        try {
            ...
            izmijeniGradStatement = conn.prepareStatement("UPDATE grad SET naziv = ?, broj_stanovnika = ?, slika=?, drzava = ?, postanski_broj=? WHERE id = ?");
    ...
    public ArrayList<Grad> gradovi() {
        ...
        try {
            ...
            while(resultGrad.next()) {
                ...
                grad.setSlika(resultGrad.getString(5));
                grad.setPostanskiBroj(resultGrad.getInt(6));
                if(drzava != null)
    ...
    public void dodajGrad(Grad grad) {
        try {
            ...
            dodajGradStatement.setString(5, grad.getSlika());
            if(grad.getDrzava() != null)
                dodajGradStatement.setInt(4, grad.getDrzava().getId());
            dodajGradStatement.setInt(6, grad.getPostanskiBroj());
    ...
    public void izmijeniGrad(Grad grad) {
        try {
            ...
            izmijeniGradStatement.setString(3, grad.getSlika());
            if(grad.getDrzava() != null)
                izmijeniGradStatement.setInt(4, grad.getDrzava().getId());
            izmijeniGradStatement.setInt(5, grad.getPostanskiBroj());
            izmijeniGradStatement.setInt(6, grad.getId());
